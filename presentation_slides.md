...
## Speaker tips (not on slides)

- **Slide 7:** Run `streamlit run app.py` live if time allows.  
- **Slide 9:** Mention Waiyaki Way / Ngong Rd as jam examples.  
- Keep each slide under ~45 seconds of talking before the next.
